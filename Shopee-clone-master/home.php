...
<body>
    <div class="app">
        <header class="header">
            <div class="grid wide">
                ...
                <div class="header-with-search">
                    ...
                    <!-- <h3 class="heading-header-search">Trang Chủ</h3> -->
                    <!-- Cart layout -->
        ...
        <section class="main-container grid wide">
            <div class="section-introduce">
                <div class="section-introduce-paragraph">
                    Good Hair Reflects Your Story And Your Spirit
                    <p>Becaue you need time for yourself</p>
                </div>
                <div class="section-introduce-img"></div>
            </div>

            <ul class="section-introduce-product-type">
                <li style="background-image: url(https://makeup-api.herokuapp.com/assets/blush-ff7992c3d7690d18a9b0224177cfbdedbc036497cf87c393ec01c6a2ef070258.svg);" 
                class="section-introduce-product-type-item">
                </li>

                <li style="background-image: url(https://makeup-api.herokuapp.com/assets/bronzer-2d423487eea3e4571229bd95689bb4eb4331f05740f3921ede7c7c765c7954b1.svg);" 
                class="section-introduce-product-type-item">
                </li>
                
                <li style="background-image: url(https://makeup-api.herokuapp.com/assets/eyeliner-de329b6d65d721a45190051af1153e23202df9eb1c393d1ac65972376ee42d50.svg);" 
                class="section-introduce-product-type-item">
                </li>

                <li style="background-image: url(https://makeup-api.herokuapp.com/assets/eyeshadow-67f9f8fd19df1862c95122f9b3460c7e6674d5a6d178cde00e6e4be908dd898a.svg);" 
                class="section-introduce-product-type-item">
                </li>
            </ul>
            <h3 class="heading-divider">Sản Phẩm Nổi Bật</h3>
            <section class="section-PopUpProduct">
                <ul class="section-PopUpProduct-list">
                    <li class="section-PopUpProduct-list-item">
                        <div class="section-PopUpProduct-item-img" style="background-image: url();"></div>
                        <h3 class="section-PopUpProduct-name">sdhiusdfadfh</h3>
                    </li>
                </ul>
                <a href="./index.html" class="btn--primary btn ReadMore-btn">Xem Thêm</a>
            </section>
            <h3 class="heading-divider">Liên Hệ Với Chúng Tôi</h3>
            <section class="section-contact">
                <input type="text" class="section-contact-input">
            </section>
        ...
        <footer class="footer">
            ...
            <div class="footer__bottom">
                <div class="grid wide">
                    <p class="footer__text">© 2021 - Bản quyền thuộc về Công ty TNHH Làm theo Video</p>
                </div>
            </div>
        </footer>
    </div>
