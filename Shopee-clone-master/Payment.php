            ...
            <ul class="List-product">
                <!-- <li class="list-product-item">
                    ...
                    <div class="item-cart-body">
                        <div class="item-cart-img" style="background-image: url();"></div>
                        <div class="item-cart-name"></div>
                        <div class="item-cart-price"></div>
                    </div> 
                </li> -->
            </ul>
            <div class="payment-section">
                <div class="payment-section-quantity">
                    <div class="btn-Buy-Prodcut btn--primary btn">Buy Nows</div>
                    <div class="payment-total btn--primary btn">0$</div>
                    <div class="payment-quantity">0</div>
                </div>
            </div>
        </div>
    </div>

    <script src="./assest/js/payment.js"></script>
</body>
</html>