                    ...
                    <form action="" id="form-login" method="POST">
                        <div class="auth-form__form">
                            <div class="auth-form__group">
                                <input type="text" class="auth-form__input" id="username-login" placeholder="Tài khoản của bạn">
                                <label for="" class="error error-name"></label>
                            </div>
                            <div class="auth-form__group">
                                <input type="password" class="auth-form__input" id="pass-login" placeholder="Mật khẩu của bạn">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#form-login").submit(function(e) {
                ...
                //  - Check password -
                if (password == '') {
                    $('.error-password').html('Password field are not empty');
                    flag = false;
                } else {
                    $('.error-password').html('');
                }
