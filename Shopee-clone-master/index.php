    ...
    <div class="app">
            ...
            <div class="modal-detail-product-body">
                ...
                <div class="modal-detail-product-contend">
                    ...
                    <div class="modal-detail-product-btns">
                        ...
                        <a href="./Payment.php" class="modal-detail-product-BuyNow modal-detail-product-btn">Mua ngay</a>
                    </div>
                </div> -->
            </div>
        </section>
                                    ...
                                    <li class="header__notify-item header__notify-item--viewed">
                                        <a href="" class="header__notify-link">
                                            ...
                                            <div class="header__notify-info">
                                                <span class="header__notify-name">Săn Voucher 100K từ #shopxuhuong</span>
                                    ...
                                    <li class="header__notify-item header__notify-item--viewed">
                                        <a href="" class="header__notify-link">
                                            ...
                                            <div class="header__notify-info">
                                                ...
                                                <span class="header__notify-description">😍Quảng cáo của Shopee đã để lại cho bạn những ấn tượng gì? Hãy chia sẻ ý kiến của bạn với Shopee ngay TẠI ĐÂY nhé!</span>
                                            </div>
                                        </a>
                                    </li>
                                    <li class="header__notify-item header__notify-item--viewed">
                                        <a href="" class="header__notify-link">
                                            ...
                                            <div class="header__notify-info">
                                                <span class="header__notify-name">Bí kíp x4 lần ưu đãi từ Shop Xtra</span>
                ...
                <div class="header-with-search">
                    ...
                    <div class="header__search">
                        <div class="header__search-input-wrap">
                            ...
                            <div class="header__search-history">
                                <div class="header__search-history-heading-wrapper">
                    ...
                    <div class="header__cart">
                        <div class="header__cart-wrap">
                            ...
                            <span class="header__cart-notice">0
                                <?php 
                            ...
                            <div class="header__cart-list">
                                ...
                                <ul class="header__cart-list-item">
                                    ...
                                    //                 <span class="header__cart-item-qnt">' . $_SESSION['cart'][$i]->SOLUONG . '</span>
                                    //             </div>
                                    //             <span class="header__cart-item-remove" onclick="handleDeleteCart()">Xoá</span>
                                    //         </div>
                                    //     </div>
                                    // </li>';
                                    // }
                                ...
                                <!-- <div class="cart-total">
                                    <h3>Total: </h3>
                                    <span id="cart-total-value"><?php if (isset($_SESSION['total'])) {echo $_SESSION['total'];} ?></span>
                                </div>
                                <div class="cart-checkout">
                                    <button class="btn-checkout"><i class="fas fa-check"></i><span>Check out</span></button>
                                </div> -->
                                ...
                                <div class="cart-checkout">
                                    <button onclick="checkOutCart()" class="btn-checkout"><i class="fas fa-check"></i><span>Check out</span></button>
                                </div>
                                <!-- <a href="./Payment.php" class="header__cart-view-cart btn btn--primary">Xem Giỏ Hàng</a> -->
                            </div>
                        </div>
            ...
            <div class="grid wide">
                <div class="row sm-gutter app__content">
                        ...
                        <nav class="category">
                            ...
                            <ul class="category-list">
                                <li class="category-item category-item--active">
                                    <a href="#" class="category-item__link">Blush</a>
                                </li>
                                <li class="category-item ">
                                    <a href="#" class="category-item__link">Bronzer</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Eyebrow</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Eyeliner</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Eyeshadow</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Foundation</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Lip liner</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Lipstick</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Mascara</a>
                                </li>
                                <li class="category-item">
                                    <a href="#" class="category-item__link">Nail polish</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="col l-10 m-12 c-12">
                        <div class="home-filter hide-on-mobile-tablet">
                            ...
                            <div class="select-input">
                                ...
                                <ul class="select-input__list">
                                    <li class="select-input__item active  increasefliter">
                                        <a href="#" class="select-input__link">Giá: Thấp đến Cao</a>
                                        <i class="fas fa-check"></i>
                                    </li>
                                    <li class="select-input__item  decreasefliter">
                        ...
                        <nav class="mobile-category">
                            <ul class="mobile-category__list">
                                <li class="mobile-category__item ">
                                    <a href="#" class="mobile-category__link">Blush</a>
                                </li>
                                <li class="mobile-category__item">
                                    <a href="#" class="mobile-category__link">Bronzer</a>
                                </li>
                                <li class="mobile-category__item">
                                    <a href="#" class="mobile-category__link">Eyebrow</a>
                                </li>
                                <li class="mobile-category__item">
                                    <a href="#" class="mobile-category__link">Eyeliner</a>
                                </li>
                                <li class="mobile-category__item">
                                    <a href="#" class="mobile-category__link">Eyeshadow</a>
                                </li>
                                <li class="mobile-category__item">
                                    <a href="#" class="mobile-category__link">Foundation</a>
                                </li>
                                <li class="mobile-category__item">
                                    <a href="#" class="mobile-category__link">Lip liner</a>
                                </li>
                                <li class="mobile-category__item">
                                    <a href="#" class="mobile-category__link">Lipstick</a>
                                </li>
                                <li class="mobile-category__item">
                                    <a href="#" class="mobile-category__link">Mascara</a>
                                </li>
                                <li class="mobile-category__item">
                                    <a href="#" class="mobile-category__link">Nail polish</a>
                                </li>
                            </ul>
                        </nav>
                        ...
                        <ul class="pagination home-product-item__pagination">
                            <li class="pagination-item pagination-item-left-btn">
                                <a class="pagination-item__link">
                                    <i class="pagination-item__icon fas fa-angle-left"></i>
                                </a>
                            </li>

                            <li class="pagination-item-page pagination-item--active">
                                <div class="pagination-item__link pageNUm">1</dib>
                            </li>
                            <li class="pagination-item  pagination-item-right-btn">
                                <a class="pagination-item__link">
        ...
        <footer class="footer">
            <div class="grid wide footer__content">
                <div class="row">
                    ...
                    <div class="col l-2-4 m-4 c-6">
                        ...
                        <ul class="footer-list">
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Blush</a>
                            </li>
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Bronzer</a>
                            </li>
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Eyebrow</a>
                            </li>
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Eyeliner</a>
                            </li>
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Eyeshadow</a>
                            </li>
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Foundation</a>
                            </li>
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Lip liner</a>
                            </li>
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Lipstick</a>
                            </li>
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Mascara</a>
                            </li>
                            <li class="footer-item">
                                <a href="#" class="footer-item__link">Nail polish</a>
                            </li>
                        </ul>
                    </div>
                    <div class="col l-2-4 m-4 c-6">
                    ...
                    <div class="col l-2-4 m-8 c-12">
                        ...
                        <div class="footer__download">
                            <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/d91264e165ed6facc6178994d5afae79.png" alt="Download QR" class="footer__download-qr">
                            <div class="footer__download-apps">
                                <a href="" class="footer__download-app-link">
                                    <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/39f189e19764dab688d3850742f13718.png" alt="App Store" class="footer__download-app-img">
                                </a>
                                <a href="" class="footer__download-app-link">
                                    <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/f4f5426ce757aea491dce94201560583.png" alt="Google Play" class="footer__download-app-img">
                                </a>
                                <a href="" class="footer__download-app-link">
                                    <img src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/assets/1ae215920a31f2fc75b00d4ee9ae8551.png" alt="AppGallery" class="footer__download-app-img">
                                </a>
            ...
            <div class="footer__bottom">
                <div class="grid wide">
                    <p class="footer__text">© 2022 - Đinh Thanh Tiên</p>
                </div>
            </div>
        </footer>
    </div>
